...
is described in [How do SSH keys work?](../ch_account/#how-do-ssh-keys-work). This section also describes how to use X2Go client
...
applications. Please see [Using an SSH agent (optional)](../ch_account/#using-an-ssh-agent-optional) if you want to know how to setup an SSH agent
in your system.
...
{% if OS == (macos or linux) %}
    2.  You should look for your **private** SSH key generated in [Generating a public/private key pair](../ch_account/#generating-a-publicprivate-key-pair). This file has
...
{% endif %}
{% if OS == windows%}        
        You should look for your **private** SSH key generated by ++"puttygen"++ exported in "*OpenSSH*" format in [Generating a public/private key pair](../ch_account/#generating-a-publicprivate-key-pair) (by
